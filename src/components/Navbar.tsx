      ...
      <div className="container mx-auto flex h-16 items-center justify-between px-4">
        <Link to="/" className="flex items-center gap-2">
          ...
          <span className="text-xl font-bold tracking-tight">
            Code<span className="text-gradient-gold">Forge</span>
          </span>
        </Link>
        ...
        <div className="hidden items-center gap-6 md:flex">
          {isAuthenticated ? (
            <>
              ...
              <Link to="/problems" className="text-sm text-muted-foreground transition-colors hover:text-foreground">
                Problems
              </Link>
              <Link to="/leaderboard" className="text-sm text-muted-foreground transition-colors hover:text-foreground">
                Leaderboard
              </Link>
              <Link to="/contests" className="text-sm text-muted-foreground transition-colors hover:text-foreground">
                Contests
              </Link>
              <Link to={`/profile/${user?.username || user?.id}`} className="flex items-center gap-2 text-sm text-muted-foreground transition-colors hover:text-foreground">
            ...
            <>
              ...
              <Button size="sm" onClick={() => navigate("/signup")} className="bg-gradient-gold font-semibold">
                Sign Up
              </Button>
            </>
          )}
          ...
          <div className="flex flex-col gap-3">
            {isAuthenticated ? (
              <>
                ...
                <Link to={`/profile/${user?.username || user?.id}`} onClick={() => setMenuOpen(false)} className="text-sm text-muted-foreground">Profile</Link>
